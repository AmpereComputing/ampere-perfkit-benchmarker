...
"""
Module containing utility functions to run DLRM, ResNet50 using pytorch framework
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--aml_dir", type=str, required=True, help="dir to ampere_model_library in docker"
    )
    parser.add_argument(
        "--model_path", type=str, required=True, help="dir to model"
    )       
    parser.add_argument(
        "--output_dir",
        type=str,
